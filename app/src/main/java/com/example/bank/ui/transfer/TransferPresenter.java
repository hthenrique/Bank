...
public class TransferPresenter implements TransferContract.UserActionsListener {
    ...
    public TransferPresenter(TransferContract.View transferView, Context context){
    ...
    @Override
    public void checkTransferStatus(String id_user_from, String id_user_to, String value) {
